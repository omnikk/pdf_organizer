...
class CertificateProcessorBalanced:
    ...
    def process_all_pdfs(self):
        ...
        print("⚖️  Запуск СБАЛАНСИРОВАННОЙ обработки")
        print("📊 Стратегия: 2-3 OCR попытки (вместо 6), DPI 300, выбор лучшего")
        print("="*60)
...
def main():
    print("⚖️  СБАЛАНСИРОВАННАЯ СИСТЕМА ОБРАБОТКИ СЕРТИФИКАТОВ")
    print("🎯 Цель: Скорость + Качество")
    print("📈 2-3 OCR попытки вместо 6 | DPI 300 | Выбор лучшего результата")
    print("="*60)
